...
class BCGroups_Admin {
	...
	public function admin_init() {
		...
		$page->get_section( 'basic_section' )->add_fields(
			array(
				// remember, we registered basic section earlier.
				array(
					'name'    => 'post_type',
					'label'   => __( 'Group Blog Post Type', 'blog-categories-for-groups' ),
					// you already know it from previous example.
					'desc'    => __( 'Set the post type for group blog.', 'blog-categories-for-groups' ),
				...
				array(
					'name'    => 'group_based_permalink',
					'label'   => __( 'How do we link to single posts?', 'blog-categories-for-groups' ),
					'desc'    => '',
					'type'    => 'radio',
					'default' => 1,
					'options' => array(
						1 => __( 'Show inside group.', 'blog-categories-for-groups' ),
						0 => __( 'Link to normal site blog post page.', 'blog-categories-for-groups' ),
					),
				),
				array(
	...
	public function admin_menu() {
		add_options_page( __( 'Blog Category Settings', 'blog-categories-for-groups' ), __( 'Blog Category Settings', 'blog-categories-for-groups' ), 'manage_options', 'blog-categories-for-groups', array(
			$this->page,
			'render',
		) );
	}
