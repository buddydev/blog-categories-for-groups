...
/**
 * Check if user can publish given post.
 *
 ...
 * @return bool
 */
function bcg_user_can_publish( $user_id, $post_id = 0 ) {
 ...
 * @return bool
 */
function bcg_user_can_edit( $post_id, $user_id, $group_id ) {
 ...
 * @return bool
 */
function bcg_user_can_delete( $post_id, $user_id, $group_id ) {
